            ...
            {ordersWithPrescriptions.map((order) => (
              ...
              >
                ...
                <div className="mb-4">
                  ...
                  <p className="text-sm text-gray-600"><strong>Total:</strong> {formatPrice(order.total)}</p>
                </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600"><strong>Total:</strong> {formatPrice(selectedOrder.total)}</p>
                </div>
